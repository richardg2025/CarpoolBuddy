...
public class PassengersAdapter extends RecyclerView.Adapter<PassengersViewHolder> {
    ...
    public PassengersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PassengersViewHolder(LayoutInflater.from(context).inflate(R.layout.passengers_item_view, parent, false));
    }
